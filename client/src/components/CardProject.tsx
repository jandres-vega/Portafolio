...
import imgPrueba from '../assets/sin foto de perfil.jpg'
            ...
            <div className="mx-auto w-fit p-12">
                <div className="w-72 h-fit group">
                    <div className="relative overflow-hidden">
                        <img className="h-96 w-full object-cover rounded-xl"
                             src={imgPrueba}
                             alt=""
                        />
                            ...
                            >
                                <div className="w-full items-center flex flex-col gap-3 mb-3">
                                    <CustomIcon className="text-center" icon={FaGithub} />
                                    <button className="bg-black border-2 w-full rounded-xl text-dark-blue font-bold">Ver</button>
                                </div>
                            </div>
                    </div>
